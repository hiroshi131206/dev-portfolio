    ...
    <section id="about" className="section">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-start">
        ...
        <div className="text-slate-200 leading-relaxed space-y-5 text-left">
          <p>
            私の強みは、<span className="text-violet-300 font-semibold">現場の課題を自ら拾い上げ、関係者を巻き込みながら技術で解決する力</span>です。
          </p>
          <p>
          ...
          <p>
            この経験と並行して、プロのナレーター活動・父親の在宅介護・学業を同時にこなす中で、<span className="text-violet-300 font-semibold">限られた時間の中で優先順位を判断し動き続ける力</span>も身についています。
          </p>
          <p>
            ラグビー13年（中学・高校ともに主将）、オープンキャンパスITコースリーダーなど、<span className="text-violet-300 font-semibold">組織の中で橋渡し役を果たすこと</span>が自分の自然な役割だと感じています。
          </p>
        </div>
