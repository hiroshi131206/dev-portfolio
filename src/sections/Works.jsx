  ...
  if (Array.isArray(media) && media.length > 0) {
    ...
    return (
      <div>
        ...
        {/* ビューア */}
        <MediaEmbed item={current} title={work.title} />
    ...
    <section id="works" className="section">
      ...
      <div className="space-y-0">
        {works.map((work, i) => (
          <article
            key={work.id}
            className="py-28 border-b border-[#1a4060]/50 first:border-t first:border-[#1a4060]/50"
          >
            <div className="grid lg:grid-cols-[3fr_2fr] gap-12 items-start">
              ...
              <div>
                ...
                <div className="flex items-center flex-wrap gap-x-4 gap-y-2 mb-5">
                  ...
                  {work.award && (
                    <span className="flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full bg-yellow-900/40 text-yellow-200 border border-yellow-600/60">
