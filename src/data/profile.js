...
export const works = [
  ...
  },
  {
    ...
    badge: 'チーム開発',
    badgeColor: 'blue',
    description: 'HAL名古屋 高度情報学科 Cグループでのチーム開発。子育て世帯向けのCtoCサイト兼総合情報支援サービスで、ベビー用品の売買・寄付ができるフリーマーケット、ベビーシッター・家事代行のマッチング、育児情報を交換できる交流掲示板、子育てカレンダー・成長日記、専門家へのオンライン相談などを提供する。「Futurum liberorum」はラテン語で「子どもたちの未来のために」の意。',
  ...
  },
  {
    ...
    badge: '企画・設計',
    badgeColor: 'amber',
    description: '訪日外国人向けに、観光ガイド・電子決済・安全管理を統合した総合プラットフォームの企画・設計（実装は未着手）。オーバーツーリズムや国内収益の不還元といった社会課題の解決を目的とし、ネイティブアプリとPWAのハイブリッド構成、地図・位置情報サービス／決済基盤／災害情報APIとの連携を前提とした設計を行っている。',
